...
(function () {
  ...
  load('mobile-nav.js?v=20260921_v166');
  load('site-footer.js?v=20260921_v166');
  load('visitor-tracker.js?v=20260921_v166');
})();
// ===========================
...
// PROMO MODAL LOGIC (Disabled auto-popup)
(function() {
...
document.addEventListener("DOMContentLoaded", function() {
  ...
  // Remove any floating audio/music button & background music
  const audioBtn = document.getElementById('globalAudioPlayerToggle') || document.querySelector('.floating-audio-btn');
